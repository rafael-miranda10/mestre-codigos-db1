...
namespace MSTestTestes
{
    ...
    public class EmpresaTeste
    {
        ...
        {
            _funcionario = new Funcionarios(FUNC_NAME_VALIDO, FUNC_SALARIO_VALIDO);
        ...
        {
            _funcionario = new Funcionarios(FUNC_NAME_INVALIDO_MAX, FUNC_SALARIO_INVALIDO);
